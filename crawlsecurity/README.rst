...
This project contains one spider called ``krebsonsecurity`` that you can see by running::
...
The ``krebsonsecurity`` spider scrapes the Open Directory Project (dmoz.org), and it's
